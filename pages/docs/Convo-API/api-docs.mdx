...
Node API Endpoint (Secondary) : [https://backup.theconvo.space/api/](https://backup.theconvo.space/api/)
...
<Callout emoji="ℹ️">
  Use `apikey=<apikey>` added as a query parameter for all requests. Returns a `401` Unauthorized Error otherwise.
